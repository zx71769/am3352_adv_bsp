...
//Wei.gang add defination of buzzer.c
#define	IOCTL_START	0x01
#define	IOCTL_ON	0x02
#define	IOCTL_OFF	0x05
//Wei.gang add end
...
#define	LEDMAN_MAX			34	/* one more than the highest LED above */
...
#define LEDMAN_CMD_GET		0x13	/* Get GPIO status */
