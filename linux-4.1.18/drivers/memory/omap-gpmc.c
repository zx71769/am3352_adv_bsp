...
EXPORT_SYMBOL(gpmc_cs_show_timings);
#else
void gpmc_cs_show_timings(int cs, const char *desc)
{
}
...
static int gpmc_probe(struct platform_device *pdev)
{
	...
	printk(KERN_INFO "====================================\n\n");
	printk(KERN_INFO "Phil: Get gpmc_memory base address 0x%p\n\n", gpmc_base);
	printk(KERN_INFO "====================================\n");
...
{
	printk(KERN_INFO "========================================\n\n");
	printk(KERN_INFO "Phil : GPMC initial...\n\n");
	printk(KERN_INFO "========================================\n");
