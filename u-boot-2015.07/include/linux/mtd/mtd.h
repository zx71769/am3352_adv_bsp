...
#define MTD_DEBUG_LEVEL4	(4) /* Debug   */

#ifdef CONFIG_MTD_DEBUG
#define pr_debug(args...)	MTDDEBUG(MTD_DEBUG_LEVEL4, args)
...
#define pr_info(args...)	MTDDEBUG(MTD_DEBUG_LEVEL3, args)
#define pr_warn(args...)	MTDDEBUG(MTD_DEBUG_LEVEL2, args)
#define pr_err(args...)		MTDDEBUG(MTD_DEBUG_LEVEL0, args)
#define pr_crit(args...)	MTDDEBUG(MTD_DEBUG_LEVEL0, args)
#define pr_cont(args...)	MTDDEBUG(MTD_DEBUG_LEVEL1, args)
#define pr_notice(args...)	MTDDEBUG(MTD_DEBUG_LEVEL4, args)
#endif
