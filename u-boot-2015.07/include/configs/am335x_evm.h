...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"findfdt="\
		...
		"if test $board_name = A335X_ADV; then " \
			"setenv fdtfile am335x-adv.dtb; fi; " \
...
#define CONFIG_SYS_ADV_NAND_U_BOOT_OFFS		0x00080000
#define CONFIG_SYS_ADV_NAND_U_BOOT_SIZE		0x00080000
