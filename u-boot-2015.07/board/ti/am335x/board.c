...
const struct dpll_params *get_dpll_ddr_params(void)
{
	...
	if (board_is_evm_sk() || board_is_adv_am3352())
...
void sdram_init(void)
{
	...
	if (board_is_evm_sk() || board_is_adv_am3352()) {
		...
		config_ddr(303, &ioregs_evm15, 
					&ddr3_evm_data,
			   		&ddr3_evm_cmd_ctrl_data,
					&ddr3_evm_emif_reg_data, 0);
	} else if (board_is_icev2()) {
		config_ddr(400, &ioregs_evmsk, 
					&ddr3_icev2_data,
			   		&ddr3_icev2_cmd_ctrl_data, 
					&ddr3_icev2_emif_reg_data, 0);
	} else {
		config_ddr(266, &ioregs,
					&ddr2_data,
			   		&ddr2_cmd_ctrl_data, 
...
#define AR8051_RGMII_TX_CLK_DLY		0x100
	if (board_is_evm_sk() || board_is_gp_evm()) {
		...
		miiphy_write(devname, 0x0, 
					AR8051_PHY_DEBUG_ADDR_REG,
					AR8051_DEBUG_RGMII_CLK_DLY_REG);
		miiphy_write(devname, 0x0, 
					AR8051_PHY_DEBUG_DATA_REG,
