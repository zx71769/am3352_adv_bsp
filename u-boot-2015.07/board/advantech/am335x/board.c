...
static struct emif_regs __maybe_unused ddr3_beagleblack_emif_reg_data = {
...
static struct emif_regs __maybe_unused ddr3_evm_emif_reg_data = {
...
static struct emif_regs __maybe_unused ddr3_icev2_emif_reg_data = {
...
void am33xx_spl_board_init(void)
{
	 ...
	 */
	if (i2c_probe(TPS65910_CTRL_I2C_ADDR)) return;
	...
	if (tps65910_voltage_update(MPU, mpu_vdd)) return;
...
set_adv_board_info_to_env(void)
{
	setenv("board_name", "A335X_ADV");
...
static struct cpsw_platform_data cpsw_data = {
	...
	.cpsw_base			= CPSW_BASE,
	/* The gmii_sel control register */ 
	.gmii_sel			= (CTRL_BASE + GMII_SEL_OFFSET),
	.mdio_div			= 0xff,
	.channels			= 8,
	.cpdma_reg_ofs		= 0x800,
	.slaves				= 1,
...
static void __maybe_unused request_and_set_gpio(int gpio, char *name)
{
	int ret;
 ...
 */
static struct clk_synth __maybe_unused cdce913_data = {
	.id = 0x81,
	.capacitor = 0x90,
	.mux = 0x6d,
	.pdiv2 = 0x2,
...
int board_eth_init(bd_t *bis)
{
...
#if (defined(CONFIG_DRIVER_TI_CPSW) && \
	!defined(CONFIG_SPL_BUILD)) || \
	(defined(CONFIG_SPL_ETH_SUPPORT) && \
	defined(CONFIG_SPL_BUILD))
	if (!getenv("ethaddr")) {
	...
	/* The Advantech board PHY setting */
